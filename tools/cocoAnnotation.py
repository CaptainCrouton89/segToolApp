# Taken from https://www.kaggle.com/ericdepotter/visualize-coco-annotations
#      Who sourced from https://www.immersivelimit.com/tutorials/create-coco-annotations-from-scratch/#create-custom-coco-dataset
...
class CocoDataset():
    ...
    def display_image(self, image_id, show_polys=True, show_bbox=True, show_labels=True, show_crowds=True, use_url=False, verbose=True):
        print('Image:')
        print('======')
        if image_id == 'random':
